      ...
      messages = [
            ...
            },
            {
                  ...
                  "content": (
                        ...
                        "Based on old hypothesis, examples and the incorrect predictions, please propose a revised hypothesis that better explains the attention head’s behavior."
...
async def main():
      ...
      while True:
            ...
            if accu >= 1.0 and f1 >= 1.0 and ndcg >= 0.95 and kendall_tau >= 0.99 and ndcg_pre >= 0.8 and kendall_tau_pre >= 0.8:
                  ...
                  hypothesis_text= await compare_and_refine_hypothesis(open_router, explanation, extracted_hypothesis, predicted_attention_text, layer, head, output_dir)
                  hypothesis_analysis, extracted_hypothesis = extract_hypothesis_text(hypothesis_text)
            if iteration >= iter:
